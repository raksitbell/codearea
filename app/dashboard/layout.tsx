  ...
  return (
    <div className="flex min-h-screen overflow-x-hidden bg-background text-foreground">
      ...
      <div
        ...
        className={`relative isolate flex min-h-screen min-w-0 flex-1 flex-col overflow-hidden bg-background transition-[margin-left] duration-200 ${
          collapsed ? "ml-[84px]" : "ml-[260px]"
        }`}
      >
        {/* Decorative glow — matches the dark "Focus workspace" board; the
            light "Admin Dashboard" mockup uses a flat canvas with no glow. */}
        <div className="pointer-events-none absolute inset-0 hidden opacity-70 dark:block">
          <div className="absolute -left-36 top-[-120px] h-[380px] w-[380px] rounded-full bg-primary/20 blur-3xl" />
